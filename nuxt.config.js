export default {
  ...
  head: {
    ...
    meta: [
      ...
      { property: 'og:url', content: 'https://mockbob.whyistilley.dev', hid: 'og:url'},
      ...
      { property: 'og:image', content: 'https://mockbob.whyistilley.dev/images/mocking-spongebob.jpeg', hid: 'og:image'},
      { property: 'twitter:card', content: 'summary_large_image', hid: 'twitter:card'},
      { property: 'twitter:url', content: 'https://mockbob.whyistilley.dev', hid: 'twitter:url'},
      ...
      { property: 'twitter:image', content: 'https://mockbob.whyistilley.dev/images/mocking-spongebob.jpeg', hid: 'twitter:image'},
    ],
    link: [
